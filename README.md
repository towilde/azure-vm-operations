...
![VM Operations](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/vm-operations.png "VM Operations")
...
![Auto-Shutdown](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/auto-shutdown.png "Auto-Shutdown")
...
![Create Vault and backup Policy](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/Create-Vault-backup-Policy.png "Create Vault and backup Policy")
...
![Backup now](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/Backup-now.png "Backup now")
...
![Backup in progress](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/Backup-in-progress.png "Backup in progress")
...
![Restore VM](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/Restore-VM.png "Restore VM")
...
![Restore Configuration](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/Restore-configuration.png "Restore Configuration")

**Figure 7:** Restore Configuration

**5)** Click on the job Notification to launch the Backup Jobs window and Monitor Progress. 

![Restore Progress](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/Restore-Progress.png "Restore Progress")
...
![VM Restored](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/VM-Restored.png "VM Restored")
...
![Configure DR](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/Configure-DR.png "Configure DR")
...
![Failover Options](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/test-failover-dr.png "Failover options")
...
![Create failover test](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/run-test-failover.png "Create failover test")
...
![Failover test stages](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/failover-test-details.png "Failover test stages")
...
![Failover test cleanup](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/dr-failover-test-cleanup.png "Failover test cleanup")
...
![Configure Update Management](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/enable-update-management.png "Configure Update Management")
...
![Missing updates](https://github.com/towilde/azure-vm-operations-lab/blob/master/Images/update-manager-missing-updates.png "Missing updates")
